...
const services = [
    ...
    },
    {
      ...
      paragraphs: [
        "Our digital branding services in Saudi Arabia include everything your business needs online:",
      ],
      lists:[
            ...
            <div className="col-span-2 flex flex-col w-[60%] gap-[1.5vw] mobile:w-full mobile:my-[10vw] mobile:gap-[5vw]">
              ...
              {service.paragraphs.map((para, paraIndex) => (
                <p
                  key={paraIndex}
                  data-para-anim
                  className="text-[1.1vw] mobile:text-[4.5vw] mobile:font-normal tablet:text-[2vw] w-[85%]"
                >
                  {para}
                </p>
              ))}
               {service.lists && service.lists.map((item, index) => (
                <ul  key={index} className='pl-[2vw] list-disc'>
                <li
                 
                  data-para-anim
                  className="text-[1.1vw] mobile:text-[4.5vw] mobile:font-normal tablet:text-[2vw]"
                >
                  {item}
                </li>
                </ul>
