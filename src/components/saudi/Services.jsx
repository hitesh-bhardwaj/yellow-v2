          ...
          <div className="">
              <div  className="grid grid-cols-7 h-full gap-x-[3vw] gap-y-[7vw] mobile:flex mobile:flex-col tablet:flex-col tablet:flex tablet:gap-y-[3vw]">
                ...
                <div className="col-start-5 col-span-5 w-full mobile:mb-[7vw] tablet:mb-[3vw]">
                  ...
                  <div 
                    className="text-[1.2vw] mb-[2vw] space-y-[1vw] mobile:text-[4.5vw] tablet:text-[2.5vw]"  
                  >
                    <p data-para-anim>As one of the most trusted marketing agencies in Saudi Arabia. We understand the local market and help you plan your next steps clearly and purposefully. Our marketing team works with you to promote your brand the right way.</p>
                    <p data-para-anim>At Yellow, we offer a full range of branding and marketing services to help businesses across Saudi Arabia build a strong image and connect with their audience.</p>
                  </div>
              ...
              <div className="col-span-1">
                <h3
                  data-para-anim
                  className="text-[2vw] font-display mobile:text-[8vw] tablet:font-medium tablet:text-[4vw]  leading-[1.4] uppercase"
                >
                 Brand Strategy
              ...
              <div className="col-span-1 mobile:hidden tablet:hidden">
                <p data-para-anim className="text-[1.2vw]">
                We help you plan how your brand should grow. Our brand strategy service in Saudi Arabia includes research, positioning, and clear goals that show what makes your business special.
                </p>
              </div>
              ...
              <div className="my-[3vw]  mt-[6vw]  col-span-3 tablet:hidden mobile:hidden">
                <Line />
              </div>
            </div>
