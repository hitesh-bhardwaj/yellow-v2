...
export default function Pagehero() {
  return (
    <>
    <section className="w-screen h-full mobile:h-[70vh] tablet:h-[45vh] bg-white" id='hero'>
        <div className="h-full flex flex-col justify-center container pt-[10%]">
          ...
          <div className='w-full h-[1px] bg-black mt-[7vw] tablet:mt-[5vw]'></div>
        </div>
      </section>
