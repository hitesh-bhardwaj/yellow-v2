    ...
    <div ref={menuRef} className="fixed top-0 z-[199] left-0 right-0 bottom-0 flex items-start justify-end pointer-events-none">
      <nav ref={navRef} className={`relative w-[50%] pointer-events-auto translate-x-[100%] left-[99px] h-screen bg-black/40 backdrop-blur-[25px] mobile:w-full tablet:w-[70%]`}>
        <div data-lenis-prevent className="w-full h-full overflow-y-auto px-[5vw] pt-[5.5vw] pb-[4.5vw] relative flex flex-col justify-between items-start mobile:pt-[25vw] mobile:pb-[10vw]">
            ...
            <li className="relative w-full">
              <div className="overflow-hidden">
                <button 
                  ...
                  <div className="rounded-full border-white border text-white text-[25%] w-[2vw] h-[2vw] flex items-center justify-center mt-2 mobile:w-[10vw] mobile:h-[10vw] mobile:mt-0">5</div>
                 </button>
              </div>
              <ul className={`service-links text-[1.3vw] font-display absolute right-[-75%] pointer-events-none top-[1.5vw] pt-[1vw] leading-[1.5] transition-all duration-1000 ease-anim-primary mobile:text-[6.5vw] mobile:static mobile:right-auto mobile:mb-[5vw] mobile:mt-[2vw]  ${serviceOpen ? "pointer-events-auto mobile:block" : "mobile:hidden"}`}>
                <li onClick={()=> {setServiceOpen(false)}} className={`absolute border rounded-full border-current h-[1.8vw] p-[0.5vw] w-[1.8vw] flex items-center leading-[2] justify-center bottom-[90%] opacity-0 left-full cursor-pointer ease-out duration-500 mobile:h-0 mobile:w-0 mobile:p-0 mobile:hidden mobile:static' ${serviceOpen ? "opacity-100" : ""} `} >
          ...
          <ul className="flex justify-between items-center text-[1vw] text-white font-medium uppercase w-[90%] mobile:flex-col mobile:items-start mobile:text-[5.5vw] mobile:gap-[2vw]">
            <li className="overflow-hidden">
              <Link 
                ...
                <svg className="relative -rotate-[135deg] w-[1vw] h-[1vw] overflow-hidden mobile:w-[6vw] mobile:h-[6vw]" width="19" height="23" viewBox="0 0 19 23" fill="none" xmlns="http://www.w3.org/2000/svg">
