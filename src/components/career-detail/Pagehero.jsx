        ...
        <div className='w-[100vw] h-[80vh] relative'>
            ...
            <div className='container absolute top-[50%] translate-y-[-50%] z-[2]'>
              <div className='text-white'>
                <h1 className='text-[5.7vw] uppercase font-display mb-[1vw] heading-anim'>
                Account Manager
                </h1>
                <p className='text-[1.4vw] mb-[3vw] para-anim'>
                ...
                <div className='flex'>
                  <div className='flex gap-[0.5vw] pr-[1.5vw] border-r-[1px] border-white'>
                    ...
                    <p className='text-[1.4vw] font-medium leading-[1.8] para-anim'>2-5 years experience</p>
                  </div>
                  <div className='flex gap-[0.5vw] px-[1.5vw] border-r-[1px] border-white'>
                    ...
                    <p className='text-[1.4vw] font-medium leading-[1.8] para-anim'>$ 70k - S 100k / annum</p>
                  </div>
                  <div className='flex gap-[0.5vw] px-[1.5vw] border-white'>
                    ...
                    <p className='text-[1.4vw] font-medium leading-[1.8] para-anim'>Benefits</p>
                  </div>
                </div>
