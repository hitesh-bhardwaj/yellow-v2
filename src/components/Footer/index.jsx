    ...
    <footer id="footer" className="footer bg-black">
        ...
        <div className="pb-[10%] pt-[5%]">
          ...
          <div className="flex justify-between items-center py-[2%]">
            <div className="w-1/2 relative">
              <h5 className="text-[5vw] capitalize leading-[1.2] font-display ">
      ...
      <div 
        ...
        <div className="fixed bottom-0 left-0 right-0 top-0 z-[-1] pb-[2vw]">
            <div className="container flex h-full flex-col justify-end text-white footer-bottom">
                ...
                <div className="flex items-start w-full justify-between mb-[8vw]">
                    <div className="w-[40%] flex flex-col gap-[2vw] items-start">
                        ...
                        <div className="flex justify-between items-start">
                            <div className="w-2/5 ">
                                <h6 className="text-[1.9vw] font-display leading-[1.2] mb-[1vw]">Dubai 21:09</h6>
                                <Link href="#" className="text-[1.15vw] font-medium">
                                    <span>Loft offices 2, Office 107, Dubai Media City, Dubai UAE</span>
                                </Link>
                            </div>
                            <div className="w-2/5 ">
                                <h6 className="text-[1.9vw] font-display leading-[1.2] mb-[1vw]">Phone</h6>
                                <Link href="tel:+971545178971" className="text-[1.15vw] font-medium">+97 154 517 8971</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-[5px]">
                        ...
                        <ul className="space-y-[1vw]">
                            <li>
                                <Link className="text-[1.15vw] font-medium uppercase" href="#">
                                    <span>
                                        Linkedin
                                    </span>
                                </Link>
                ...
                <div className="w-full flex items-center justify-between relative">
                    ...
                    <button aria-label="Scroll Down Button" onClick={handleScroll} className="absolute cursor-pointer scroll-btn w-fit left-1/2 -translate-x-1/2 text-[1.15vw] group flex gap-[10px] items-center justify-center">
                        <span className="relative leading-[1.5] after:absolute after:block after:bottom-0 after:left-0 after:h-[1.5px] after:w-full after:bg-current after:transition-all after:duration-500 after:ease-out group-hover:after:scale-x-0">Scroll To Top</span>
                        <svg className="relative w-[1vw] h-[1w] overflow-hidden rotate-[180deg]" viewBox="0 0 19 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-[1.15vw] font-medium capitalize">
                        <p>By: <Link href="https://weareenigma.com" className="">Enigma Digital</Link></p>
                    </div>
                </div>
