      ...
      <section className=" w-full h-full pb-[5%]" id="detail">
        <div className="grid grid-cols-3 container">
          <div className="col-span-2 flex flex-col w-[80%] gap-[1.5vw]">
            ...
            <p className="text-[1.2vw] font-medium mb-[2vw]">
          ...
          <div className="h-[2px] col-span-3 bg-black my-[4vw]"></div>
          <div className="col-span-2 flex flex-col w-[80%] gap-[1.5vw]">
            <h2 className="text-[2.5vw] font-display">Brand architecture</h2>
            <p className="text-[1.2vw] font-medium">
          ...
          <div className="h-[2px] col-span-3 bg-black my-[4vw]"></div>
          <div className="col-span-2 flex flex-col w-[80%] gap-[1.5vw]">
            <h2 className="text-[2.5vw] font-display">Staff engagement</h2>
            <p className="text-[1.2vw] font-medium">
          ...
          <div className="flex flex-col gap-[1.5vw]">
            <h3 className="text-[2vw] font-display">
            Brand Strategy

            </h3>
            <ul className="list-disc pl-[1.5vw]">
                
            <li className="text-[1.2vw] font-medium">
            Brand Guidelines
