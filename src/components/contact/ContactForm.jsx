...
export default function ContactForm() {
  ...
  return (
    <section className="px-[5vw] pt-0 py-[5%] tablet:py-[10%] mobile:pt-[25%]" id="contact-form">
      <h3
        data-para-anim
      ...
      <Form {...form} >
        <form onSubmit={form.handleSubmit(onSubmit)} className="form flex flex-wrap gap-y-[2vw] mobile:gap-[2.5vw] mobile:gap-y-[7vw] mobile:py-[10vw] tablet:gap-y-[2vw] fadeup">
          ...
          <div className="w-full flex justify-center items-center  mt-[3vw] mobile:justify-start">
            <Button
              type="submit"
              className="text-[1.4vw] px-[1.4vw] py-[0.6vw] min-w-[12vw] bg-body border relative border-body rounded-full min-h-[3.5vw] flex gap-[0.5vw] overflow-hidden hover:bg-body group tablet:text-[2vw] tablet:min-w-[15vw] tablet:px-[3vw] tablet:h-[6vw] tablet:py-[1.2vw] mobile:text-[4vw] mobile:px-[6vw] mobile:h-[14vw]"
            >
              ...
              <span className="absolute block w-full h-full scale-y-0 bg-body group-hover:scale-y-100 left-0 top-0 origin-bottom transition-all duration-700 ease-link overflow-hidden" />
                    {!isLoading ? (
                      <span
                        ...
                        className="relative inline-block after:content-[attr(data-text)] after:absolute after:top-[130%] after:left-0 group-hover:translate-y-[-130%] transition-transform duration-1000 ease-link z-[10] mobile:group-hover:text-white"
                      >
                        Send Message
                      </span>
                    ) : (
                   ...
                   {!isLoading?(<svg
                      className="relative -rotate-[135deg] w-[1.1vw] h-[1.1vw] tablet:w-[2vw] tablet:h-[2vw] mobile:w-[5vw] mobile:h-[5vw] mobile:group-hover:fill-white "
                      width="19"
                      height="23"
                      viewBox="0 0 19 23"
                      fill="none "
                    ...
                    >
                      <path
                        className="origin-center -translate-y-[110%] scale-0 group-hover:translate-y-0 group-hover:scale-100 transition-all duration-500 ease-out mobile:group-hover:fill-white "
                      ...
                      />
                      <path
                        className="origin-center group-hover:scale-0 group-hover:translate-y-[110%] transition-all duration-500 ease-out mobile:group-hover:fill-white "
                        d="M9.44186 23C9.38605 22.9324 9.33953 22.8559 9.27442 22.7973C6.25116 19.8649 3.22791 16.9369 0.204652 14.009C0.139535 13.9459 0.0604662 13.8964 1.30208e-06 13.8468C0.576745 13.2973 1.12558 12.7748 1.66512 12.2613C3.82326 14.3514 6.01861 16.4775 8.2093 18.6036C8.23256 18.5901 8.26047 18.5811 8.28372 18.5676C8.28372 12.3829 8.28372 6.19369 8.28372 -4.68423e-07C9.09768 -4.32844e-07 9.87442 -3.98892e-07 10.6744 -3.63923e-07C10.6744 6.19369 10.6744 12.3784 10.6744 18.5901C12.893 16.4369 15.0884 14.3108 17.2651 12.2027C17.8465 12.7568 18.3907 13.2838 19 13.8739C18.9488 13.9009 18.8558 13.9324 18.7907 13.9955C15.7581 16.9279 12.7302 19.8649 9.70233 22.7973C9.64186 22.8559 9.5907 22.9324 9.53488 23C9.50698 23 9.47442 23 9.44186 23Z"
                        fill="currentColor"
                      />
                    </svg>):(<></>)}
