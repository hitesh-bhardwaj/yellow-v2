...
export default function Pagehero() {
  return (
    <>
    <section className='w-screen h-screen relative flex items-center  mobile:py-[15%] mobile:flex-col mobile:items-start mobile:justify-end mobile:h-[80vh] tablet:w-full tablet:h-[50vh] dark' id='hero'>
