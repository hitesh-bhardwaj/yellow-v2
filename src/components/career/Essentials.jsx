  ...
  return (
    <section id="essentials">
      <div className="container py-[8%] mobile:py-[15%]">
        <div className="w-[50%] flex flex-col gap-[2vw] mb-[12vw] mobile:w-full mobile:gap-[5vw] tablet:w-[70%]">
        ...
        <div className="w-[40%] flex flex-col gap-[2vw] mb-[5vw] mobile:w-full tablet:w-[70%]">
          <h2 data-title-anim className="text-[4.8vw] font-display mobile:text-[10vw] tablet:text-[6vw] ">Essentials</h2>
          ...
          {essentialsData.map((item, index) => (
            ...
            >
              <div className="w-full">
                <span data-title-anim className="text-[6.5vw] font-bold font-display mb-[1.5vw] mobile:text-[17vw] mobile:font-normal tablet:text-[8vw] ">{`0${item.id}.`}</span>
