...
export default function TeamDetail({ index, handleClose  , detailOpen}) {
  ...
  return (
    <>
      <section data-lenis-prevent id='team-detail' className={`w-full bg-transparent fixed h-full  top-0 right-0 overflow-y-auto overflow-scroll detail-section z-[204] flex justify-end pointer-events-none `}>
        <div className='bg-[#000000] w-full h-full detail-overlay opacity-0'></div>
        <div  className={` w-[70%] px-[5vw] absolute right-0 flex flex-col gap-[2vw] bg-white h-full overflow-y-auto overflow-scroll z-[205] pointer-events-auto mobile:w-full mobile:gap-[5vw] tablet:w-[80%] tablet:gap-[3vw] ${detailOpen ? "transition-all ease-in duration-300" : "translate-x-[100%] transition-all ease-out duration-300"}`}>
          ...
          <div className='flex flex-col gap-[1.5vw] text-[1.85vw] font-medium mobile:text-[4.5vw] mobile:gap-[3vw] tablet:text-[3vw] tablet:gap-[2vw]'>
            <p>{member.content1}</p>
            <p>{member.content2}</p>
            <p>{member.content3}</p>
            <div className='flex flex-col gap-[0.5vw] mobile:gap-[2vw] mobile:my-[4vw]'>
            <p className='opacity-40'>Email</p>
            <Link href={`mailto:${member.email}`} className='mb-[1vw]'>{member.email}</Link>
            <p className='opacity-40'>Social Media</p>
            <Link href={"#"}>{member.LN}</Link>
             </div> 
