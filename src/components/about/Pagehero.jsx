    ...
    <>
      <section className=" w-screen h-full" id="hero">
        ...
        <div className="w-full h-full pt-[15%] flex items-center mb-[7vw] mobile:pt-[30%] ">
          <h1 data-title-anim className="text-[5.7vw] font-display uppercase heading-anim mobile:text-[12vw]">Who We Are</h1>
        </div>

        <div className="flex gap-[5vw] w-full mobile:flex-col mobile:gap-[10vw]">
          <div className="flex flex-col gap-[4vw] w-[65%] mobile:order-2 mobile:w-full mobile:gap-[10vw]">
            <div className="flex gap-[1vw] mobile:flex-col mobile:mt-[4vw] ">
              <h3 data-title-anim className="text-[1.6vw] w-[30%] font-display uppercase heading-anim mobile:text-[7vw] mobile:w-full">
                We Are
              </h3>
              <p data-para-anim className="text-[1.3vw] w-full para-anim mobile:text-[4vw]">
          ...
          <div className=" h-[40vw] w-[40vw] relative imageanim mobile:w-[85vw] mobile:h-[105vw]">
