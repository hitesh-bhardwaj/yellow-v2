  ...
  return (
    ...
    <section className=' h-full w-full py-[10%]' id='values'>
        ...
        <div className='flex w-full gap-[1.5vw] mt-[8vw]'>
            <div className='w-[30vw] h-[25vw] rounded-[15px] bg-[#222222] py-[2vw] px-[2vw] border-[0.5px] border-white border-opacity-50 drop-shadow-2xl shadow-2xl'>
            ...
            <div className='w-[30vw] h-[25vw] rounded-[15px] bg-[#222222] translate-y-[20%] py-[2vw] px-[2vw] border-[0.5px] border-white border-opacity-50 drop-shadow-2xl shadow-2xl relative'>
                <div className='text-white'>
            ...
            <div className='w-[30vw] h-[25vw] rounded-[15px] bg-[#222222] translate-y-[40%] py-[2vw] px-[2vw] border-[0.5px] border-white border-opacity-50 drop-shadow-2xl shadow-2xl relative '>
                <div className='text-white' >
