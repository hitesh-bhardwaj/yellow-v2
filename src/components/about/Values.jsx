        ...
        <div className="container card-block ">
          ...
          <div className="w-full h-[100vh] flex items-center card-section mobile:h-full mobile:mt-[7vw] tablet:h-full">
            <div className=" h-[100vh] w-full py-[7%] flex justify-between items-center mobile:h-full mobile:flex-col mobile:gap-[7vw] tablet:flex-wrap tablet:gap-y-[5vw] tablet:h-full tablet:pt-[10%]">
              <div className="card-container relative w-[29vw] h-[35vw] rounded-[15px] card1 mobile:w-[90vw] mobile:h-[100vw] tablet:w-[40vw] tablet:h-[50vw]">
                <div className="absolute top-0 left-0 w-[29vw] h-[35vw] bg-[#222222] cardfront flex items-center justify-center rounded-[20px] overflow-hidden border-white border-[1px] mobile:w-[90vw] mobile:h-[100vw] tablet:w-[40vw] tablet:h-[50vw]">
                  <img
              ...
              <div className="card-container relative w-[29vw] h-[35vw] rounded-[15px] card2 mobile:w-[90vw] mobile:h-[100vw] tablet:w-[40vw] tablet:h-[50vw]">
                <div className="absolute top-0 left-0 w-[29vw] h-[35vw] bg-[#222222] cardfront flex items-center justify-center rounded-[20px] overflow-hidden border-white border-[1px] mobile:w-[90vw] mobile:h-[100vw] tablet:w-[40vw] tablet:h-[50vw]">
                  <img
              ...
              <div className="card-container relative w-[29vw] h-[35vw] rounded-[15px] card3 mobile:w-[90vw] mobile:h-[100vw] tablet:w-full tablet:h-[50vw]  ">
                <div className="absolute top-0 left-0 w-[29vw] h-[35vw] bg-[#222222] cardfront flex items-center justify-center rounded-[20px] overflow-hidden border-white border-[1px] mobile:w-[90vw] mobile:h-[100vw] tablet:w-[40vw] tablet:h-[50vw] ">
                  <img
