...
const LinkButton = ({btnLink, btnText, className= ""}) => {
    return (
        <Link className={`cursor-pointer flex w-fit relative text-[1.4vw] gap-[0.5vw] items-center font-medium group mobile:gap-[2vw] tablet:text-[2.5vw] mobile:text-[5.5vw] ${className}`} href={btnLink}>
