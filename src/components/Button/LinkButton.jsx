...
const LinkButton = ({btnLink, btnText, className= ""}) => {
    return (
        <Link className={`cursor-pointer flex w-fit relative text-[1.2vw] gap-[0.5vw] items-center font-medium group mobile:text-[5vw] tablet:text-[3vw] mobile:gap-[2vw] ${className}`} href={btnLink}>
