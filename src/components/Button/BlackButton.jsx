...
const BlackButton = ({btnLink, btnText, className=""}) => {
    return (
        <Link href={btnLink} className={` cursor-pointer relative block text-[1.2vw] w-fit h-fit text-body border border-body hover:text-white transition-all duration-700 ease-link py-[0.8vw] px-[1.2vw] mobile:px-[6vw] mobile:py-[3.5vw] rounded-full font-medium group overflow-hidden mobile:text-[4vw] ${className}`}>
            ...
            <div className="overflow-hidden flex items-center gap-[0.5vw] w-full relative mobile:gap-[2vw]">
                ...
                <svg className="relative -rotate-[135deg] w-[1.1vw] h-[1.1vw] overflow-hidden mobile:w-[5vw] mobile:h-[5vw]" width="19" height="23" viewBox="0 0 19 23" fill="none" xmlns="http://www.w3.org/2000/svg">
