...
export default function Pagehero() {
  return (
    <>
    <section id='hero' className='py-[12%] mobile:py-[7%]'>
        <div className='container h-[120vh] flex items-center mt-[5vw] mobile:h-full'>
        <div className='mobile:w-full mobile:h-full mobile:flex mobile:flex-col mobile:pt-[120%] mobile:gap-[5vw]'>
            <div className='w-[90vw] h-[45vw] relative rounded-[10px] overflow-hidden mb-[3vw] fadeup mobile:absolute mobile:top-0 mobile:left-0 mobile:w-screen mobile:h-[50vh] mobile:rounded-none'>
            ...
            <div className='flex gap-[1vw] mb-[3vw] mobile:mb-[7vw] mobile:gap-[2vw] '>
                <span className='px-[1.4vw] py-[0.2vw] border-[1px] border-black border-opacity-60 rounded-[50px] text-[1.4vw] font-medium fadeup mobile:text-[4vw] mobile:px-[3vw] mobile:py-[0.5vw]'>
                Branding
                </span>
                <span className='px-[1.4vw] py-[0.2vw] border-[1px] border-black border-opacity-60 rounded-[50px] text-[1.4vw] font-medium fadeup mobile:text-[4vw] mobile:px-[3vw] mobile:py-[0.5vw]'>
                Digital
