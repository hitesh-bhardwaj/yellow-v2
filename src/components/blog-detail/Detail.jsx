          ...
          <div className="grid grid-cols-3 gap-x-[3vw] mobile:flex mobile:flex-col mobile:gap-[7vw]">
            <div className="col-start-1">
              <div className="flex flex-col mb-[4vw]">
                <h3 data-title-anim className="font-display text-[1.8vw] font-medium mb-[1.5vw] mobile:text-[7vw] ">
                  Posted On :
                </h3>
                <p data-para-anim className="text-[1.2vw] font-medium mobile:text-[5vw] ">June 6, 2024</p>
              </div>
              <div className="flex flex-col">
                ...
                <div className="flex gap-[0.7vw] mobile:gap-[2vw]">
                    <Link href={"/"}>
                    <div className="w-[3vw] h-[3vw] relative fadeup mobile:w-[10vw] mobile:h-[10vw]">
                    <Image
            ...
            <div className="col-start-2 col-span-2">
              <p data-para-anim className="text-[2vw] font-medium mb-[2vw] mobile:text-[5vw] ">
              ...
              <p data-para-anim className="text-[2vw] font-medium mb-[2vw]  mobile:text-[5vw]  mobile:mb-[12vw] ">
            ...
            <div className="col-start-2 col-span-2">
              <h2 data-para-anim className="text-[2.5vw] font-display mb-[2vw] mobile:text-[7vw] mobile:mb-[5vw] ">
              ...
              <p data-para-anim className="text-[1.2vw] font-medium mb-[3vw] mobile:text-[4.5vw] mobile:font-normal mobile:mb-[12vw] ">
            ...
            <div className="col-start-2 col-span-2">
              ...
              <p data-para-anim className="text-[1.2vw] font-medium mb-[2vw] mobile:text-[4.5vw] mobile:font-normal mobile:mb-[12vw] ">
