      ...
      <Section id="relatedBlog" className="bg-black">
        <div className="container pt-[5%] pb-[8%] bg-white mobile:pb-[20%]">
          ...
          <div className="flex justify-between gap-[2vw] mobile:flex-col mobile:gap-[7vw]">
            ...
            {posts.map((post) => (
              <div key={post.slug} className="w-full border border-black/20 rounded-[10px] overflow-hidden group fadeup mobile:h-full tablet:hidden">
                <div className="h-[16vw] relative mobile:h-[50vw]">
                  <Image
                  ...
                  <div className="absolute top-[7%] left-[7%] flex gap-[1vw] text-white mobile:gap-[2vw]">
                    <div className="w-fit border-[1px] border-white rounded-full backdrop-blur-lg px-[1.4vw] py-[0.2vw] text-[1vw] mobile:text-[4vw] mobile:px-[3vw]">
                ...
                <div className="w-full h-full px-[1.5vw] py-[1.5vw] flex flex-col gap-[2vw] mobile:px-[4vw] mobile:py-[7vw] mobile:gap-[5vw]">
                  ...
                  <LinkButton
                    ...
                    className="text-[1.3w] mobile:text-[5vw]"
                  />
                </div>
              </div>
            ))}          
