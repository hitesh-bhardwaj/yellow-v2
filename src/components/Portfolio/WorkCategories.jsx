...
const WorkCategories = ({ workcategories, activeCategory, setActiveCategory }) => {
  ...
  return (
    <div className='flex gap-[1.5vw] flex-wrap w-full h-fit mobile:gap-[2vw] mobile:mb-[7vw]'>
      <Link key={"all"} href="/our-work" onClick={() => setActiveCategory('all')} className={`group overflow-hidden relative text-body border hover:text-white transition-all duration-300 ease-out border-body rounded-full px-[1.5vw] text-[1.3vw] py-[0.3vw] leading-[1.2] fadeup mobile:text-[3.5vw] mobile:py-[1.5vw] mobile:px-[3.5vw] tablet:text-[1.8vw] tablet:py-[0.7vw] ${activeCategory === 'all' ? 'bg-body text-white hover:animate-none' : ''}`}>
