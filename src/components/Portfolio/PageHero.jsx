  ...
  return (
    <>
      <section className="w-screen h-full mobile:h-[70vh] bg-white tablet:h-full tablet:w-full" id="hero">
        <div className=" h-full flex flex-col justify-center container tablet:py-[15%] pt-[10%]">
          ...
          <div className="tablet:hidden mobile:block h-[1px] w-full bg-black mt-[6vw] "></div>
        </div>
      </section>
    </>
  );
