            ...
            <div className="w-full flex justify-between items-start mt-[2vw] mb-[4vw]">
                <div className="flex items-start gap-[2vw]">
                    ...
                    <div className="flex flex-col h-[16vw] justify-between items-start">
                        ...
                        <p className="text-[1.1vw] font-medium fadeUp">{formatDate(date)}</p>
                    </div>
                </div>
                <div className="h-[5vw] fadeIn w-[5vw] flex items-center justify-center border border-body rounded-full group-hover:bg-body transition-all duration-500 group-hover:text-white">
