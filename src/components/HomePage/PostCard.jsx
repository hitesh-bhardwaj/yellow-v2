        ...
        <div className="group hide-first-child">
            ...
            <div className="w-full flex justify-between items-start mt-[2vw] mb-[4vw] mobile:flex-col mobile:mt-[12vw]">
                <div className="flex items-start gap-[2vw] mobile:flex-col">
                    <Link href="#">
                        <div className="h-[16.5vw] w-[26.5vw] relative rounded-[1.5vw] overflow-hidden imganim mobile:w-[85vw] mobile:h-[27vh] mobile:rounded-[20px]">
                            <Image
                                src={src}
                                alt="blog image" 
                                priority={false}
                    ...
                    <div className="flex flex-col h-[16vw] justify-between items-start mobile:h-full mobile:gap-[3vw] mobile:pl-[2vw]">
                        <Link href={link} className="">
                            <h4 data-para-anim className="text-[2.5vw] font-medium w-[43vw] leading-[1.3] mobile:text-[6vw] mobile:w-full ">
                                {title}
                            </h4>
                        </Link>
                        <p className="text-[1.1vw] font-medium fadeUp mobile:text-[4vw] fadeup">{formatDate(date)}</p>
                    </div>
                </div>
                <div className="h-[5vw] fadeIn w-[5vw] flex items-center justify-center border border-body rounded-full group-hover:bg-body transition-all duration-500 group-hover:text-white mobile:h-[15vw] mobile:w-[15vw] mobile:my-[5vw]">
                    <svg className="relative -rotate-[135deg] w-[1.7vw] h-[1.7vw] overflow-hidden mobile:w-[6vw] mobile:h-[6vw]" width="19" height="23" viewBox="0 0 19 23" fill="none" xmlns="http://www.w3.org/2000/svg">
