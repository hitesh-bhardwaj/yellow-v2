        ...
        <div className="group hide-first-child">
            ...
            <div className="w-full flex justify-between items-start mt-[2vw] mb-[4vw] mobile:flex-col mobile:mt-[12vw]">
                <div className="flex items-start gap-[2vw] mobile:flex-col">
                    ...
                    <div className="flex flex-col h-[16vw] justify-between items-start mobile:h-full mobile:gap-[3vw] mobile:pl-[2vw]">
                        <Link href={link} className="">
                            <h4 data-para-anim className="text-[2.5vw] font-medium w-[43vw] leading-[1.3] mobile:text-[5.5vw] mobile:w-full tablet:text-[3vw] ">
                                {title}
                            </h4>
                        </Link>
                        <p className="text-[1.1vw] font-medium fadeUp mobile:text-[4vw] fadeup tablet:text-[2vw]">{formatDate(date)}</p>
                    </div>
                </div>
                <div className="h-[5vw] fadeIn w-[5vw] flex items-center justify-center border border-body rounded-full group-hover:bg-body transition-all duration-500 group-hover:text-white mobile:h-[15vw] mobile:w-[15vw] tablet:w-[8vw] tablet:h-[8vw] mobile:my-[5vw]">
                    <svg className="relative -rotate-[135deg] w-[1.7vw] h-[1.7vw] overflow-hidden mobile:w-[6vw] mobile:h-[6vw] tablet:w-[4vw] tablet:h-[4vw]" width="19" height="23" viewBox="0 0 19 23" fill="none" xmlns="http://www.w3.org/2000/svg">
