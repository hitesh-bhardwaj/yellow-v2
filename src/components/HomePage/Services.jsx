...
const SingleAccordion = ({ id, title, content1, content2, btnLink, btnText }) => {
    return (
        <AccordionItem value={id}>
            ...
            <AccordionTrigger className="text-[2.2vw] mobile:text-[6vw] mobile:text-left amobile:flex mobile:w-full text-body font-display font-normal py-[3%] mobile:py-[10%]  accordion [&[data-state=open]>.line>.line-internal>.icon]:rotate-[90deg] [&[data-state=open]>.line>.line-internal>.icon>.minus]:rotate-90 [&[data-state=open]>.line>.line-internal>.icon]:bg-body [&[data-state=open]>.line>.line-internal>.icon]:text-white">
                {title}
            </AccordionTrigger>
