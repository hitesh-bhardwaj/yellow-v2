...
const serviceData = [
    ...
    },
    {
        ...
        link: "/contact-us",
        btnText: "Contact Us",
        description: "<p>As a homegrown agency with deep roots in the UAE, we specialize in launching and rebranding brands to thrive in this dynamic market. From tech and retail to hospitality and FMCG, we've helped local brands scale to new heights—whether it's creating disruptive concepts like  <a class='link-style font-medium' href='/our-work/cafu-branding-and-digital'>Cafu</a> and <a class='link-style font-medium' href='/our-work/olioli-branding'>OliOli</a> or revitalizing legacy names like  <a class='link-style font-medium' href='/our-work/barakat'>Barakat</a> and <a class='link-style font-medium' href='/our-work/pan-home-case-study'>Pan Emirates (now Pan Home).</a></p><br><p>If you're an international company looking to enter the UAE, we bring insider market knowledge, cultural insights, and strategic expertise to ensure your brand resonates with the region's diverse audience. Beyond branding, we connect you with key industry leaders and decision-makers, helping you establish the right partnerships to accelerate your success.</p><br><p>The UAE is a land of opportunity—let's make sure your brand stands out.</p>"
    },
];
...
const SingleAccordion = ({ id, title, content, btnLink, btnText }) => {
    return (
        <AccordionItem value={id}>
            ...
            <AccordionTrigger className="text-[2.2vw] mobile:text-[6vw] mobile:text-left mobile:flex mobile:w-full tablet:text-[4vw] tablet:text-left text-body font-display font-normal py-[3%] mobile:py-[5%] accordion [&[data-state=open]>.line>.line-internal>.icon-container>.icon]:rotate-[90deg] [&[data-state=open]>.line>.line-internal>.icon-container>.icon>.minus]:rotate-90 [&[data-state=open]>.line>.line-internal>.icon-container>.icon]:bg-body [&[data-state=open]>.line>.line-internal>.icon-container>.icon]:text-white">
                {title}
            </AccordionTrigger>
        ...
        <Section className="py-[5%] mobile:pb-[15%]" id="services">
            <div ref={containerRef} className="container">
                <div className="space-y-[2.5vw] mobile:space-y-[7vw] tablet:mt-[5vw] mobile:mt-[5vw]">
                    ...
                    <p className="text-[1.9vw] font-medium w-[35%] mobile:text-[4vw] mobile:w-[90%] tablet:text-[3vw] tablet:w-[60%] ">
