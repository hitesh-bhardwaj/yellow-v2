...
const SingleAccordion = ({ id, title, content1, content2, btnLink, btnText }) => {
    return (
        <AccordionItem value={id}>
            ...
            <AccordionTrigger data-para-anim className="text-[2.2vw] text-body font-display font-normal py-[3%]  accordion [&[data-state=open]>.line>.line-internal>.icon]:rotate-[90deg] [&[data-state=open]>.line>.line-internal>.icon>.minus]:rotate-90 [&[data-state=open]>.line>.line-internal>.icon]:bg-body [&[data-state=open]>.line>.line-internal>.icon]:text-white">
                {title}
            </AccordionTrigger>
        ...
        <Section className="py-[5%]" id="services">
            <div ref={containerRef} className="container">
                <div className="space-y-[2.5vw] mt-[5vw]">
                    ...
                    <p data-para-anim className="text-[1.9vw] font-medium w-[35%] ">
