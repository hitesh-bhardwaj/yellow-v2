                ...
                <div className="bg-body pt-[5%] pb-[10%] text-white relative min-h-screen mobile:py-[15%]">
                    <div className="container mb-[8vw]">
                        <div className="space-y-[1.5vw] mobile:space-y-[4vw]">
                            ...
                            <p className="text-[1.2vw] font-medium fadeIn mobile:text-[4vw] tablet:text-[3vw]">Our Clients</p>
                            </Copy>
                            <Copy>

                            <h4 className="text-[2.5vw] font-display leading-[1.35] w-1/2 mobile:text-[6.5vw] mobile:w-full tablet:text-[3.5vw] tablet:w-[60%]">
