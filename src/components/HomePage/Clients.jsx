            ...
            <div className="bg-body pt-[5%] pb-[10%] text-white relative min-h-screen mobile:py-[15%]">
                <div className="container mb-[8vw]">
                    <div className="space-y-[1.5vw] mobile:space-y-[4vw]">
                        ...
                        <h4 data-para-anim className="text-[2.5vw] font-display leading-[1.35] w-1/2 mobile:text-[7.5vw] mobile:w-full tablet:text-[3.5vw] tablet:w-[60%] ">Small or large, local or far, all of our clients are connected with our purpose of perfect execution.</h4>
                    </div>
                </div>
                <div className="mb-[18vw] w-full overflow-hidden">
                    <BrandsMarquee />
                </div>
                <div className="w-full container overflow-hidden relative z-10">
