        ...
        return (
            <div className="group">
                ...
                <div className="w-full flex justify-between items-start mt-[2vw] mb-[4vw]">
                    ...
                    <div className="h-[5vw] fadeUp w-[5vw] flex items-center justify-center border border-body rounded-full group-hover:bg-body transition-all duration-500 group-hover:text-white">
